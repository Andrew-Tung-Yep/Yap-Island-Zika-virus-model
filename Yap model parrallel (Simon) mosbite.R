...
setwd(nl.path)
drop.path <- "/home/andrew/Yap geographical sir (R) mosbite.nlogo" # The model
folderdir <- "/home/andrew/RNetlogo" # Where you want to save the results file
tabname <- "zika_parallel_mosbite.csv" # Name of results file to be written
#```
...
write.csv(parmatrix,paste(folderdir,"zika_parallel_parmatrix_mosbite.csv",sep=""),row.names=F)
#````